...
namespace MahApps.Metro.Controls
{
    ...
    public class MetroWindow : Window
    {
        ...
        public static readonly DependencyProperty GlowBrushProperty = DependencyProperty.Register("GlowBrush", typeof(Brush), typeof(MetroWindow), new PropertyMetadata(Brushes.Transparent));
        ...
        private void UseDropShadow()
        {
            ...
            this.SetCurrentValue(GlowBrushProperty, new SolidColorBrush(Colors.Black));
        }
        ...
        private void MetroWindow_Loaded(object sender, RoutedEventArgs e)
        {
            ...
            //   NativeMethods.SetWindowRgn(hwnd, NativeMethods.CreateRoundRectRgn(0, 0, Convert.ToInt32(this.ActualWidth), Convert.ToInt32(this.ActualHeight), 2, 2), true);
        ...
        private void MetroWindow_SizeChanged(object sender, RoutedEventArgs e)
        {
            ...
            //   IntPtr hwnd = new System.Windows.Interop.WindowInteropHelper(this).Handle;
            // 创建圆角窗体  12 这个值可以根据自身项目进行设置 
            //  NativeMethods.SetWindowRgn(hwnd, NativeMethods.CreateRoundRectRgn(0, 0, Convert.ToInt32(this.ActualWidth), Convert.ToInt32(this.ActualHeight), 5, 5), true);
        }
