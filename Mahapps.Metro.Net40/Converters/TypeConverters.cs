...
namespace MahApps.Metro.Converters
{
    ...
    /// 左转向灯转换器
    /// </summary>
    public class LeftLightColorConverter : IValueConverter
    {
        public object Convert(
            object value,
            Type targetType,
            ...
            CultureInfo culture)
        {
            SolidColorBrush radBrush = new SolidColorBrush(Colors.White);
            //  0：未打方向灯
            //1：左转方向灯
            //2：右转方向灯
            if (value != null)
            {
                ...
                {
                    case 1:
                        radBrush = new SolidColorBrush(Colors.Yellow);
                        break;
                }
            }
            return radBrush;
    ...
    /// 右转向灯转换器
    /// </summary>
    public class RightLightColorConverter : IValueConverter
    {
        public object Convert(
            object value,
            Type targetType,
